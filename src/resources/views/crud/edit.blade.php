...
@php
  $defaultBreadcrumbs = [
    ...
    trans('backpack::crud.edit_entity', ["entity_name" => $crud->entity_name]) => false,
  ];
...
@section('header')
	<section class="container-fluid">
	  <h2>
        <span class="text-capitalize">{!! $crud->getHeading() ?? trans('backpack::crud.edit_entity', ["entity_name" => $crud->entity_name]) !!}</span>
